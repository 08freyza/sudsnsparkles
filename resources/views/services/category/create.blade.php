            ...
            <div class="row">
                <div class="col-lg-8 col-12">
                    ...
                    <div class="mb-2 pb-1">
                        ...
                        <input type="text" class="form-control px-3 py-2" id="last_number" name="last_number" placeholder="Your last number" value="0" disabled>
                    </div>
                    <div class="mb-2 pb-1">
                        <label for="additional_info" class="fw-medium fs-17">Additional Information</label>
                        <textarea class="form-control" id="additional_info" name="additional_info" placeholder="Your additional information" rows="4">{{ old('additional_info') }}</textarea>
                    </div>
                    <div class="my-2 pb-1">
                ...
                <div class="col-4 d-lg-block d-none">
                    <div class="position-relative">
                        <img class="z-3 position-absolute top-0 end-0 mt-5 me-5 rounded-3 border" src="{{ asset('assets/img/services.jpg') }}" alt="main-image" width="225" height="315">
