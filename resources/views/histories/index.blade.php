                            ...
                            <tbody>
                                @foreach ($order as $eachOrder)
                                    <tr class="align-middle">
                                        <td><span class="d-md-inline d-none">{{ $eachOrder->order_id }}</span><a class="d-md-none d-inline text-decoration-none" href="{{ url((Auth::guard('admin')->check() == true ? 'admin' : '') . '/history/' . $eachOrder->order_id) }}">{{ $eachOrder->order_id }}</a></td>
                                        ...
                                        <td class="d-md-table-cell d-none">
                                            <a href="{{ url((Auth::guard('admin')->check() == true ? 'admin' : '') . '/history/' . $eachOrder->order_id) }}" class="btn btn-sm btn-primary me-1">
